...
function ConfigFooter( { generatedUrl, doGenerate, isBusy, uploading, downloadName, isBlockEditorPage = false, optionalPrompt = '' } ) {
	return (
		<div className="flex flex-row gap-[12px]">
			{ generatedUrl ? (
				...
				<Button onClick={ doGenerate } disabled={ isBusy || uploading || (isBlockEditorPage && optionalPrompt.trim() === '')}>
					{ isBusy
